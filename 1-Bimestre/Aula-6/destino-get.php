...
<body>
    <div class="container">
    <H1 class=" p-3 text-primary">Destino</H1>
    </div>
<hr>
<div class="container">
    <?php
    ...
    <br>
    <p>
        <a class="py-4 pe-3 nav-link" href="destino-get.php?nome=Henrique&email=Henrique@gmail.com&corbg=<?= $corbg; ?>" >
            Enviar dados nome=Henrique e Email=Henrique@gmail.com!
        </a>
